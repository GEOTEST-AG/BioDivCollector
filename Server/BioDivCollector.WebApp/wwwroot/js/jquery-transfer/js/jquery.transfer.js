            ...
            <div class="transfer-double" id="transfer_double_{{= self.id }}">
                ...
                <div class="transfer-double-content clearfix">
                    ...
                    <div class="transfer-double-content-middle">
                        <div class="btn-select-arrow" id="add_selected_{{= self.id }}"><i class="icofont-double-right"></i></div>
                        <div class="btn-select-arrow" id="delete_selected_{{= self.id }}"><i class="icofont-double-left"></i></div>
                    </div>
