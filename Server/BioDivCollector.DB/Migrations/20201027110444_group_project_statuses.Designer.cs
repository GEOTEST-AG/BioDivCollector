...
namespace BioDivCollector.DB.Migrations
{
    ...
    [Migration("20201027110444_group_project_statuses")]
    partial class group_project_statuses
    {
            ...
            modelBuilder.Entity("BioDivCollector.DB.Models.Domain.ReferenceGeometry", b =>
                {
                    ...
                    b.HasIndex("ProjectId")
                        .HasName("ix_geometries_projectid");
            ...
            modelBuilder.Entity("BioDivCollector.DB.Models.Domain.Record", b =>
                {
                    ...
                    b.HasOne("BioDivCollector.DB.Models.Domain.Project", "Project")
                        .WithMany("Records")
                        .HasForeignKey("ProjectId")
                        .HasConstraintName("fk_records_projects_projectid");
            ...
            modelBuilder.Entity("BioDivCollector.DB.Models.Domain.ReferenceGeometry", b =>
                {
                    b.HasOne("BioDivCollector.DB.Models.Domain.Project", "Project")
                        .WithMany("Geometries")
                        .HasForeignKey("ProjectId")
                        .HasConstraintName("fk_geometries_projects_projectid");
