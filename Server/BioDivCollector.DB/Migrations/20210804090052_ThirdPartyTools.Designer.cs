...
namespace BioDivCollector.DB.Migrations
{
    ...
    [Migration("20210804090052_ThirdPartyTools")]
    partial class ThirdPartyTools
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BioDivCollector.DB.Models.Domain.FormField", b =>
                {
                    ...
                    b.Property<int?>("PublicMotherFormFieldFormFieldId")
                        .HasColumnName("publicmotherformfieldformfieldid")
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("UseInRecordTitle")
                        .HasColumnName("useinrecordtitle")
                        .HasColumnType("boolean");
                    ...
                    b.HasIndex("PublicMotherFormFieldFormFieldId")
                        .HasName("ix_formfields_publicmotherformfieldformfieldid");

                    b.ToTable("formfields");
                });

            modelBuilder.Entity("BioDivCollector.DB.Models.Domain.FormFormField", b =>
                {
                    b.Property<int>("FormId")
                        .HasColumnName("formid")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("FormId", "FormFieldId")
                        .HasName("pk_formsformfields");

                    b.HasIndex("FormFieldId")
                        .HasName("ix_formsformfields_formfieldid");

                    b.ToTable("formsformfields");
                });
            ...
            modelBuilder.Entity("BioDivCollector.DB.Models.Domain.ProjectForm", b =>
                {
                    b.Property<Guid>("ProjectId")
                        .HasColumnName("projectid")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("ProjectId", "FormId")
                        .HasName("pk_projectsforms");

                    b.HasIndex("FormId")
                        .HasName("ix_projectsforms_formid");

                    b.ToTable("projectsforms");
                });
            ...
            modelBuilder.Entity("BioDivCollector.DB.Models.Domain.ProjectGroup", b =>
                {
                    ...
                    b.HasIndex("GroupStatusId")
                        .HasName("ix_projectsgroups_groupstatusid");
            ...
            modelBuilder.Entity("BioDivCollector.DB.Models.Domain.ProjectThirdPartyTool", b =>
                {
                    ...
                    b.HasKey("ProjectThirdPartyToolId")
                        .HasName("pk_projectthirdpartytool");

                    b.HasIndex("ProjectId")
                        .HasName("ix_projectthirdpartytool_projectid");

                    b.HasIndex("ThirdPartyToolId")
                        .HasName("ix_projectthirdpartytool_thirdpartytoolid");

                    b.ToTable("projectthirdpartytool");
                });
            ...
            modelBuilder.Entity("BioDivCollector.DB.Models.Domain.FormField", b =>
                {
                    ...
                    b.HasOne("BioDivCollector.DB.Models.Domain.FormField", "PublicMotherFormField")
                        .WithMany()
                        .HasForeignKey("PublicMotherFormFieldFormFieldId")
                        .HasConstraintName("fk_formfields_formfields_publicmotherformfieldformfieldid");
                });

            modelBuilder.Entity("BioDivCollector.DB.Models.Domain.FormFormField", b =>
                {
                    b.HasOne("BioDivCollector.DB.Models.Domain.FormField", "FormField")
                        .WithMany("FormFieldForms")
                        .HasForeignKey("FormFieldId")
                        .HasConstraintName("fk_formsformfields_formfields_formfieldid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BioDivCollector.DB.Models.Domain.Form", "Form")
                        .WithMany("FormFormFields")
                        .HasForeignKey("FormId")
                        .HasConstraintName("fk_formsformfields_forms_formid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("BioDivCollector.DB.Models.Domain.Group", b =>
                {
                    b.HasOne("BioDivCollector.DB.Models.Domain.User", "Creator")
                        .WithMany()
                        .HasForeignKey("CreatorId")
                        .HasConstraintName("fk_groups_users_creatorid");
            ...
            modelBuilder.Entity("BioDivCollector.DB.Models.Domain.ProjectForm", b =>
                {
                    b.HasOne("BioDivCollector.DB.Models.Domain.Form", "Form")
                        .WithMany("FormProjects")
                        .HasForeignKey("FormId")
                        .HasConstraintName("fk_projectsforms_forms_formid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("BioDivCollector.DB.Models.Domain.Project", "Project")
                        ...
                        .HasForeignKey("ProjectId")
                        .HasConstraintName("fk_projectsforms_projects_projectid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("BioDivCollector.DB.Models.Domain.ProjectGroup", b =>
                {
                    ...
                    b.HasOne("BioDivCollector.DB.Models.Domain.GroupStatus", "GroupStatus")
                        .WithMany()
                        .HasForeignKey("GroupStatusId")
                        .HasConstraintName("fk_projectsgroups_groupstatuses_groupstatusid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BioDivCollector.DB.Models.Domain.ProjectThirdPartyTool", b =>
                {
                    b.HasOne("BioDivCollector.DB.Models.Domain.Project", "Project")
                        ...
                        .HasForeignKey("ProjectId")
                        .HasConstraintName("fk_projectthirdpartytool_projects_projectid");
                    ...
                    b.HasOne("BioDivCollector.DB.Models.Domain.ThirdPartyTool", "ThirdPartyTool")
                        ...
                        .HasConstraintName("fk_projectthirdpartytool_thirdpartytools_thirdpartytoolid");
                });
            ...
            modelBuilder.Entity("BioDivCollector.DB.Models.Domain.UserHasProjectLayer", b =>
                {
                    b.HasOne("BioDivCollector.DB.Models.Domain.Layer", "Layer")
                        .WithMany("LayerUsedByProjectUser")
                        .HasForeignKey("LayerId")
